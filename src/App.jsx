      ...
      <div style={{ display: "grid", gap: 14 }}>
        ...
        <button
          ...
          onMouseOver={(e) => {
            ...
            e.currentTarget.style.boxShadow = "0 6px 24px rgba(0,210,255,0.3)";
          }}
          onMouseOut={(e) => {
      ...
      <div style={{ display: "grid", gap: 14 }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 12 }}>
          <div>
            ...
            <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Ex: Avalanche" style={inputStyle} />
          </div>
          <div>
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 17, color: "#fff", letterSpacing: 1.5 }}>
              {asset.name}
            </span>
            {asset.objective && (
              <span
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4, background: "rgba(255,255,255,0.05)", borderRadius: 10, padding: "6px 4px" }}>
              <button
                ...
                style={{ background: "none", border: "none", cursor: "pointer", color: "rgba(255,255,255,0.4)", padding: "4px 8px", borderRadius: 6, display: "flex", alignItems: "center" }}
              >
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    color: activeView === v.key ? "#00d2ff" : "rgba(255,255,255,0.4)",
                    transition: "all 0.2s",
                  }}
                >
                  {v.label}
            ...
            <button
              ...
              onMouseOver={(e) => {
                e.currentTarget.style.transform = "translateY(-1px)";
                e.currentTarget.style.boxShadow = "0 6px 24px rgba(0,210,255,0.35)";
              }}
              onMouseOut={(e) => {
                e.currentTarget.style.transform = "none";
                e.currentTarget.style.boxShadow = "0 4px 16px rgba(0,210,255,0.2)";
              }}
            >
              <PlusIcon /> Investir
            </button>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontFamily: "'DM Sans', sans-serif", fontSize: 13 }}>
                ...
                <tbody>
                  ...
                  <tr style={{ borderTop: "2px solid rgba(0,210,255,0.2)", background: "rgba(0,210,255,0.04)" }}>
                    ...
                    <td style={{ padding: "14px 16px", textAlign: "center", fontFamily: "'Bebas Neue', sans-serif", fontSize: 18, color: "#00d2ff", fontWeight: 700 }}>
